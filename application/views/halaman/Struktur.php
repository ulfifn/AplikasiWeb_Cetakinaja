    ...
    <section class="content">
      ...
      <div class="col-12">
        <div class="btn float-right">
          <td>
            <a href="/cetakinaja/index.php/tambahcetakinaja/tambahstruktur"><button type="button" class="btn btn-block btn-primary"><i class="fas fa-lg fa-plus"></i> Tambah</button></a>
          </td>
        </div>
      </div>
    </div>
